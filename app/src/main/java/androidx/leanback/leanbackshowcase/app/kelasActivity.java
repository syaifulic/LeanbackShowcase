...
public class kelasActivity extends LeanbackActivity{
...
//        youtubePlayerView.setAutoPlayerHeight(this);
        ...
        youtubePlayerView.initializeWithCustomURL("vJU97RPolMU", params, new YoutubePlayerView.YouTubeListener() {
            ...
            public void sendMessage(View view) {
                Intent intent = new Intent(kelasActivity.this, YoutubePlayerFullscreen.class);
            ...
            public void onPlaybackQualityChange(String arg) {
                ...
                Toast.makeText(kelasActivity.this, message, Toast.LENGTH_LONG).show();
            }
