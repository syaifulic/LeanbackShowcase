...
public class lobbyActivity extends LeanbackActivity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.detail_lobby);
...
//        youtubePlayerView.setAutoPlayerHeight(this);
        ...
        youtubePlayerView.initializeWithCustomURL("rg_GEpK35CA", params, new YoutubePlayerView.YouTubeListener() {
            ...
            public void sendMessage(View view) {
                Intent intent = new Intent(lobbyActivity.this, YoutubePlayerFullscreen.class);
